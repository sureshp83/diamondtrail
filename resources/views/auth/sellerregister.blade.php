...
@section('content')
    ...
    <h1 class="main-title">REGISTER AS A SELLER</h1>
    <div class="container">
        <div id="register-as-a-buyer">
            <form method="POST" id="sellerreg" name="sellerreg" action="{{ URL::to('register/seller') }}" autocomplete="off" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group file-btn">
                                        ...
                                        <label class="custom-file-label" for="association">UPLOAD PDF</label>
                                                <input type="file" name="memorandom_certificate" class="custom-file-input" id="association" accept=".pdf">
