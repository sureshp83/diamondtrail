    ...
    <div id="post-a-diamond" class="req-a-diamond">
        <div class="row">
            ...
            <div class="col-xl-9 col-lg-8 col-md-12 col-xs-12">
                <form method="post" name="buyerpostdiamondstep1" action="{{URL::to('buyer/update-request')}}"  enctype="multipart/form-data">
                    {{csrf_field()}}
                        ...
                        <div id="page-right-content">
                            ...
                            <div class="diamond_details">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-4 col-xs-12 carat">
                                    ...
                                    <div class="col-lg-1 col-md-4 col-xs-12 carat vertically-center text-sm-center">
                            ...
                            <div class="brand-box">
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-xs-12">
                                        <div class="form-group">
                                        <?php $brandids=explode(',',$diamond_detail['brand_id']);?>
                                            <!--<label class="control-label">Producer</label>-->
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <?php $certiids=explode(',',$diamond_detail['certification_laboratory_id']);?>
                                            <select name="certification_laboratories_id[]" id="certification_laboratories_id" class="multiSelect" multiple="multiple">
                                                ...
                                                @foreach($certification_laboratories as $certificate)
                                                    ...
                                                    <option {{(isset($diamond_detail) && in_array($certificate->id,$certiids)) ? 'selected' :''}} value="{{$certificate->id}}">{{$certificate->label}}</option>
                            ...
                            <div class="footer-buttons text-sm-right">
                                <a class="btn btn-secondary float-sm-left" href="{{URL::to('/buyer/all-request')}}">Cancel</a>
