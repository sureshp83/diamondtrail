 ...
 <div class="page-content">
    <div class="container">
        <div id="my-account">
            ...
            <form method="post" action="{{URL::to('buyer/myaccount')}}" autocomplete="off" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group {{$errors->has('province_id') ? 'has-error' : ''}}">
                                        <label class="control-label" for="province_id">State/Province</label>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="identification">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <a class="btn btn-inverse text-uppercase" href="{{URL::to('buyer/reset-password')}}">Reset Your Password</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                                        <p class="uploaded-file"></p>-->
                                        ...
                                        <a href="javascript:void(0);" class="uploaded-file">{{$userdetail->profiles->incorporation_certificate}}</a>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-lg-12">
...
<!--                                        <p class="uploaded-file"></p>-->
                                        ...
                                        <a href="javascript:void(0);" class="uploaded-file">{{$userdetail->profiles->memorandom_certificate}}</a>
                                        @endif
...
<!--                                        <p class="uploaded-file"></p>-->
                                            <a href="#" class="uploaded-file">Provenance_claim.pdf</a>
                ...
                <div class="row bottom-btns">
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        ...
                        <input type="button" class="btn btn-inverse" value="become a Seller" name="become_a_seller" id="become_a_seller">
                        @endif
                    </div>
 ...
 <form method="post" action="{{URL::to('buyer/becomeseller')}}">
 {{csrf_field()}}
        <div class="alert-box text-sm-center">
            <h3>Are you sure <br>
                you want become a seller ?</h3>
            <a href="javascript:void(0);" onclick="closeAlert()" class="btn btn-inverse">Cancel</a>
            <button type="submit" class="btn btn-primary becameBuyer">BECOME A SELLER</button>
        </div>
 </form>       
    </div>

<script type="text/javascript">
    $("#become_a_seller").on("click",function(){
