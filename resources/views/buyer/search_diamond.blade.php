@extends('layouts.app')
@section('title','Search diamond')
@section('content')
    <div id="search-diamond" CLASS="buyer-acc-page">
        <div class="row">
            <div class="col-xl-2 col-lg-3 col-md-12 col-xs-12">
                <div class="sidebar-sticky" id="sidebar-two">
                    <div class="sidebar-filters">
                        ...
                        <a href="{{URL::to('/buyer/search-diamond')}}" class="btn btn-inverse"><img src="{{asset('images/icon-reset.png')}}" alt="Reset" title="Reset" width="16px">&nbsp;&nbsp; Reset Filters</a>
                    </div>
                </div>
            </div>
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        <div id="page-right-content" class="filter-box">
                            ...
                            <p class="total-found text-sm-right diamondcount">{{$ActiveRecCount}} Diamonds Found</p>
                ...
                <div class="modal-content">
                    <div class="big-modal-header">
                        <button type="button" class="close hide-in-mobile" data-dismiss="modal" aria-label="Close">
                            Back to search&nbsp;&nbsp;&nbsp;<span aria-hidden="true"><img src="{{asset('images/btn-close-grey.png')}}" alt="close" title="close"></span>
                        </button>
                ...
                <div class="modal-content">
                    <div class="big-modal-header">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-12 header-section-right vertically-center rightheader">
                                <div class="box-three">
                                    <ul class="list-inline">
                                        ...
                                        <li class="list-inline-item">
                                            <span class="text-uppercase">Mine</span>
                                            <p id="mainmine"></p>
                                        </li>
                                        <li class="list-inline-item">
                                            <span class="text-uppercase">Producer</span>
                                            <p id="mainproducer"></p>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <button type="button" class="close hide-in-mobile closeresearchmodal"  data-dismiss="modal" aria-label="Close">
                            Back to search&nbsp;&nbsp;<span aria-hidden="true"><img src="{{asset('images/popup-close.png')}}" alt="close" title="close"></span>
                        </button>
                        <button type="button" class="close hide-in-desktop" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true"><i class="fas fa-chevron-left"></i></span>&nbsp;&nbsp; Close
                        </button>
                                    ...
                                    <div class="model-left-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-xs-12 text-sm-center">
                                                <a href="#" class="btn btn-primary sellernobtn">Call Seller</a>
                                                <p id="comp_phno" style="display:none"></p>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-xs-12 text-sm-center">
                                                <a href="" class="btn btn-primary selleremail">Email Seller</a>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-xs-12 text-sm-center">
                                        ...
                                        <div class="table-box-two">
                                            ...
                                            <br>
                                            <a href="" target="_blank" class="btn btn-inverse float-sm-right download-pdf">
...
CalledAjax(filtersection,datesection,dropdownsection);
        function CalledAjax(filtersection,datesection,dropdownsection){
            ...
            table = $('#myTable').DataTable({
                ...
                ajax: {
                    "url":"{{URL::to('/buyer/AjaxSearchDiamond')}}",
                    "type": "POST",
                    "data":array,
                },
                columnDefs: [ {
        ...
        $('#compareselect').click(function (){
            var dataArr = [];
            $.each($("#myTable tr.selected"),function(){ //get each tr which has selected class
                var id =  $('td:eq(2)', this).text();
                console.log(id);
                dataArr.push(id); //find its first td and push the value
            ...
            if(dataArr.length>0){
            $.ajax({
                url:"{{URL::to('buyer/compareDiamond')}}",
                data:param,
                type:"post",
                success:function(response){
                    ...
                    for(var i=0;i<length;i++) {
                        pophtml +='<td><a href="javascript:void(0);" data-toggle="modal" data-target="#research_slider" onclick="getDiamondFulldetail('+rec['id'][i]+')" class="btn btn-primary">View Diamond</a></td>';
                    }
                    pophtml+='</tr>';
        ...
        function getDiamondFulldetail(id) {
            $("#comp_phno").hide();
            $.ajax({
                url:"{{URL::to('buyer/getDiamondFullDetail')}}",
                data:"id="+id,
                type:"get",
                success:function(response){
                    var popviewhtml="";
                    ...
                    $(".leftheader #maintotalprice").text(rec['carat']*parseInt(rec['price']));
                    ...
                    var bodyhtml='<table>'+
                        ...
                        bodyhtml+='<table>'+
                                     ...
                                     '</tr>'+
                                  '</table>';      
                    $(".selleremail").attr("href","mailto:"+rec.user_email+"?Subject="+rec['id']+",%20"+rec['carat']+",%20"+rec['shape_label']+",%20%20-The Diamond Trail.");
                    $(".sellershare").attr("href","mailto:?Subject="+rec['id']+",%20"+rec['carat']+",%20"+rec['shape_label']+",%20%20-The Diamond Trail.&body="+bodyhtml);
                    popviewhtml+='<tr>'+
                        '<td>Date Posted</td>'+
                        '<td align="right">'+rec['created_at']+'</td>'+
                        '</tr>'+
                    ...
                    $(".download-pdf").attr("href","{{URL::to('buyer/download-as-pdf')}}/"+rec['id']);
                }
            });
        }   
