    ...
    <tr>
		...
		<td style="padding-top: 10px;padding-bottom: 10px;">
		                        <table width="60%" style="margin:0  auto;  border-collapse: collapse;">
		                            	...
		                            	<tr>
		                                <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;"> Admin changed your account password.</td>
		                               </tr>
		                               <tr>
		                               <td style="color: #242424; padding:10px 20px; background:#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">This is Your New Password.</td>
		                               </tr> 

		                               <tr>
		                               <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">{{$cnf_password}}. </td>
		                               </tr> 
