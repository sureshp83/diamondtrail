    ...
    <tr>
		...
		<td style="padding-top: 10px;padding-bottom: 10px;">
		                        <table width="60%" style="margin:0  auto;  border-collapse: collapse;">
		                            	...
		                            	<tr>
		                                <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">{{$first_name}}, Welcome to Diamondtrail.</td>
		                               </tr>
		                               <tr>
		                               <td style="color: #242424; padding:10px 20px; background:#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">You are Successfully Register as {{$usertype}}.</td>
		                               </tr> 

		                               <tr>
		                               <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">Here is link oh home page. </td>
		                               </tr> 
		                               ...
		                               <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif; text-align:center;">
		                               	<a class="btn btn-primary" href="{{URL::to('/')}}">Home Page</a>
		                               <br>
        							   </td>
		                               </tr> 
		                               <td style="color: #242424; padding:10px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;"></td>
