...
@section('content')
    <div class="about_us">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 text-sm-center">
                            <div class="content-img">
                                <figure>
                                    <img src="{{asset('images/about-img-1.jpg')}}" alt="About Us" title="About Us">
                                </figure>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-xs-12 text-sm-center">
                            <div class="content-img">
                                <figure>
                                    <img src="{{asset('images/about-img-2.jpg')}}" alt="About Us" title="About Us">
                                </figure>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-12">
                ...
                <section>
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 text-sm-center">
                            <div class="content-img">
                                <figure>
                                    <img src="{{asset('images/img-about-us-03.jpg')}}" alt="About Us" title="About Us">
                                </figure>
                            </div>
                        </div>
                    </div>
        ...
        <section id="about-us-bottom" class="image-overlay-box">
            <div class="image-overlay">
                <figure>
                    <img src="{{asset('images/about_us_bg.jpg')}}" alt="About US" title="About US">
                </figure>
            </div>
