...
@section('content')
<div class="landing-front-side">
        <div class="banner-section">
            <figure>
                <img src="images/about-us-banner.png" alt="Banner" title="Banner">
            </figure>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12 text-sm-center">
                            <div class="content-img">
                                <figure>
                                    <img src="images/about-img-1.jpg" alt="About Us" title="About Us">
                                </figure>
                            </div>
                        </div>
                    </div>
                ...
                <section>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-xs-12 text-sm-center">
                            <div class="content-img">
                                <figure>
                                    <img src="images/about-img-2.jpg" alt="Traceability Program" title="Traceability Program">
                                </figure>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-xs-12">
                            <div class="content-text">
                                <h2 class="title text-sm-left text-capitalize">Traceability Program</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec pellentesque massa
                                    vitae semper facilisis.Class aptent taciti sociosqu ad litora torquent per conubia
                                    nostra, per inceptos himenaeos.</p>
                                <ul>
        ...
        <section id="producers-list">
            <div class="container">
                <h2 class="title text-sm-center text-capitalize">Producers</h2>
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-xs-12">
                        <div class="producer-single-slide">
                            <figure>
                                <img src="images/about-img-2.jpg" title="Producer" alt="Producer">
                            </figure>
                            <h3>Producer Name</h3>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec pellentesque massa vitae semper facilisis.
                            </p>
                            <a href="#" class="btn btn-primary">Learn more</a>
                        </div>
                    </div>
        ...
        <section id="landing-front-bottom" class="image-overlay-box">
            <div class="image-overlay">
                <figure>
                    <img src="images/about_us_bg.jpg" alt="About Us" title="About US">
                </figure>
            </div>
