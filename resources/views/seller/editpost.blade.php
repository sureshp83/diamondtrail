...
<div id="post-a-diamond">
        <div class="row">
                    ...
                    <div class="sidebar-content">
                        ...
                        <ul class="step-list">
                            <li class="active-step">
                                <span>1</span><a href="#">Diamond Details</a>
                                <ul>
                                    <li class="active-step">1. Origin</li>
                                    <li>2. Price</li>
                                    <li>3. Diamond Details</li>
                                    <li>4. Brand</li>
                                    <li>5. Certification</li>
                                    <li>6. Images</li>
                                </ul>
                            </li>
                        </ul>
            ...
            <form method="post" name="sellerpostdiamondstep1" action="{{URL::to('seller/update-diamond')}}"  enctype="multipart/form-data">
            {{csrf_field()}}
                    ...
                    <div class="container-fluid">
                        <div id="page-right-content">
                            ...
                            <div class="footer-buttons text-sm-right">
                                <a href="{{URL::to('seller/all-post') }}" class="btn btn-secondary" style="float:left">Cancle</a>
