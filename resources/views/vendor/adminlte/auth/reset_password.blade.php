...
@section('content')
    ...
    <div id="app">
        ...
        <div class="login-logo">
            <a href="{{ url('/home') }}"><b>Diamond</b>Trail</a>
        </div><!-- /.login-logo -->
        ...
        <div class="login-box-body">
            ...
            <form action="{{ URL::to('admin/password/reset') }}" method="post">
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Password" name="confirmation_password"/>
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                </div>
