...
@section('contentheader_title','Edit About Us Content')
@section('main-content')
<div class="box box-primary admin">
<form role="form" method="post" id="adminedituser" name="adminedituser" action="{{URL::to('/admin/content/about-us')}}" enctype="multipart/form-data">
{{csrf_field()}}
