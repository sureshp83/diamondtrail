    ...
    <tr>
        ...
        <td style="padding-top: 10px;padding-bottom: 10px;">
                                <table width="60%" style="margin:0  auto;  border-collapse: collapse;">
                                        ...
                                        <tr>
                                        <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">Hello.</td>
                                       </tr>
                                       <tr>
                                       <td style="color: #242424; padding:10px 20px; background:#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">You are receiving this email because we received a password reset request for your account..</td>
                                       </tr> 
                                       ...
                                       <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif; text-align:center;">
                                        <a class="btn btn-primary" href="{{$actionUrl}}">Reset Password</a>
                                       <br>
                                       </td>
                                       </tr> 

                                       <tr>
                                       <td style="color: #242424; padding:10px 20px; background :#f8f8f8; letter-spacing: 0.2px;font-size: 16px;font-family: sans-serif;">If you did not request a password reset, no further action is required. </td>
                                       </tr> 
                                       ...
                                       <tr>
                                       <td style="padding:10px 20px; letter-spacing: 0.2px;font-size: 13px;font-family: sans-serif;">
